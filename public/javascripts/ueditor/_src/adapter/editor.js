    ...
    EditorUI.prototype = {
        ...
        _updateFullScreen:function () {
            if (this._fullscreen) {
                ...
                this.getDom().style.cssText = 'border:0;position:absolute;left:0;;height:' + vpRect.height + 'px;z-index:' + (this.getDom().style.zIndex * 1 + 100);
        ...
        _scale:function () {
            ...
            function down() {
                ...
                scalelayer.style.cssText = "position:absolute;left:0;display:;top:0;background-color:#41ABFF;opacity:0.4;filter: Alpha(opacity=40);height:"
